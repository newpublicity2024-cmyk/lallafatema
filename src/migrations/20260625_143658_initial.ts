...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor', 'journalist');
  CREATE TABLE "posts_recipe_ingredients" (
  ...
  CREATE TABLE "posts_recipe_instructions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"step" varchar
  ...
  CREATE TABLE "posts" (
  	...
  	"recipe_prep_time" varchar,
  	"recipe_cook_time" varchar,
  	"recipe_servings" varchar,
  ...
  CREATE TABLE "_posts_v_version_recipe_ingredients" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"item" varchar,
  ...
  CREATE TABLE "_posts_v_version_recipe_instructions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"step" varchar,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_is_recipe" boolean DEFAULT false,
  	"version_recipe_prep_time" varchar,
  	"version_recipe_cook_time" varchar,
  	"version_recipe_servings" varchar,
  	"version_recipe_cuisine" varchar,
  ...
  CREATE TABLE "users" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"role" "enum_users_role" DEFAULT 'journalist' NOT NULL,
  	"bio" varchar,
  	"avatar_id" integer,
  	"title" varchar,
  ...
  ALTER TABLE "posts_recipe_ingredients" ADD CONSTRAINT "posts_recipe_ingredients_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_recipe_instructions" ADD CONSTRAINT "posts_recipe_instructions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_version_recipe_ingredients" ADD CONSTRAINT "_posts_v_version_recipe_ingredients_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_version_recipe_instructions" ADD CONSTRAINT "_posts_v_version_recipe_instructions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "magazine_issues" ADD CONSTRAINT "magazine_issues_pdf_id_media_id_fk" FOREIGN KEY ("pdf_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_magazine_issues_v" ADD CONSTRAINT "_magazine_issues_v_version_pdf_id_media_id_fk" FOREIGN KEY ("version_pdf_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "posts_recipe_ingredients_order_idx" ON "posts_recipe_ingredients" USING btree ("_order");
  CREATE INDEX "posts_recipe_ingredients_parent_id_idx" ON "posts_recipe_ingredients" USING btree ("_parent_id");
  CREATE INDEX "posts_recipe_instructions_order_idx" ON "posts_recipe_instructions" USING btree ("_order");
  CREATE INDEX "posts_recipe_instructions_parent_id_idx" ON "posts_recipe_instructions" USING btree ("_parent_id");
  ...
  CREATE INDEX "_posts_v_version_recipe_ingredients_order_idx" ON "_posts_v_version_recipe_ingredients" USING btree ("_order");
  CREATE INDEX "_posts_v_version_recipe_ingredients_parent_id_idx" ON "_posts_v_version_recipe_ingredients" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_version_recipe_instructions_order_idx" ON "_posts_v_version_recipe_instructions" USING btree ("_order");
  CREATE INDEX "_posts_v_version_recipe_instructions_parent_id_idx" ON "_posts_v_version_recipe_instructions" USING btree ("_parent_id");
  ...
  CREATE INDEX "magazine_issues_pdf_idx" ON "magazine_issues" USING btree ("pdf_id");
  ...
  CREATE INDEX "_magazine_issues_v_version_version_pdf_idx" ON "_magazine_issues_v" USING btree ("version_pdf_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "posts_recipe_ingredients" CASCADE;
  DROP TABLE "posts_recipe_instructions" CASCADE;
  DROP TABLE "posts" CASCADE;
  DROP TABLE "posts_rels" CASCADE;
  DROP TABLE "_posts_v_version_recipe_ingredients" CASCADE;
  DROP TABLE "_posts_v_version_recipe_instructions" CASCADE;

...
export interface Post {
  ...
  title: string;
  /**
   * اتركه فارغًا وسنكتبه تلقائيًا من بداية المقال.
   */
  excerpt?: string | null;
  featuredType?: ('image' | 'video') | null;
  /**
   * الصورة الرئيسية التي تظهر أعلى المقال وفي قوائم الموقع.
   */
...
export interface Media {
  id: number;
  /**
   * جملة قصيرة تصف الصورة. مثال: إطلالة الفنانة خلال حفل توزيع الجوائز بالرباط.
   */
  alt: string;
  caption?: string | null;
  /**
